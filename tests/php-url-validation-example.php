<?php
/**
 * @see https://medium.com/terales-engineering/validate-url-with-utf-8-symbols-in-php-e3b0434c96bf
 * @see https://github.com/terales/php-url-validation-example/blob/master/index.php
 */
...
function getUrlTestCases() {
    ...
    return [
        ...
        'http://windows.microsoft.com/en-us/windows/turn-???-computer-faq#1TC=windows-vista',
